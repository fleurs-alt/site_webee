...
<body>
	...
	<div class="slider">
			...
			<img src="images/accueil/slider/slider2.png" alt="Panier livré chez vous" class="img_slider" loading=lazy />
			<img src="images/accueil/slider/slider3.png" alt="Marque éco-responsable" class="img_slider" loading=lazy />	
		<div class="suivant">
	...
	<section class="meillsection">
		...
		<div class="row5">
			<div class="product-item">
					<div class="product_image">
						<a href="produit_huile.html"><img src="images/produit3.png" alt="Huile aromatisée ROMERO" loading=lazy></a>
					</div>
					<div class="favorite"></div>
						<div class="product_info">
							<h5 class="product_name"><a href="produit_huile.html">Huile aromatisée ROMERO</a></h5>
		...
		<div class="row5">
			<div class="product-item">
					...
					<div class="product_bubble product_bubble_left product_bubble_green d-flex flex-column "><span>PRO</span></div>
						<div class="product_info">
							<h5 class="product_name"><a href="produit_pate.html">Tapenade de Vizcántar</a></h5>
		...
		<div class="row5">
			<div class="product-item">
					<div class="product_image">
						<a href="produit_confiture.html"><img src="images/confiture.png" alt="Confiture d’olives Águra" loading=lazy></a>
					</div>
					<div class="favorite"></div>
						<div class="product_info">
							<h5 class="product_name"><a href="#">Confiture d’olives Águra</a></h5>
		...
		<div class="container">
			<div class="row">
				<div class="avantfooter-col">
					...
					<div class="avfooter">
						<img class="avfooterlogo" src="images/af1.png" alt="Paiement sécurisé" loading=lazy>
					</div>
				</div>
				<div class="avantfooter-col">
					<p>Aide et contact</p>
				...
				<div class="avantfooter-col">
					...
					<div class="avfooter">
						<img class="avfooterlogo" src="images/af4.png" alt="Livraison gratuite dès 120€" loading=lazy>
					</div>
				</div>
			</div>
		</div>
