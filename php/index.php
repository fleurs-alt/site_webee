...
<body>
			...
			<div class="container">
				<div class="navbar">
					<ul>
						...
						<li>
							...
							<div class="sous-menu">
								<ul>
									...
									<li><a href="epicerie.html">Epicerie</a></li>
						...
						<li><a href="blogaccueil.html">Blog</a></li>
	
						<li><a href="#"><img class="loupe" src="images/loupe.svg" alt="loupe" loading=lazy></a></li>
						<li><a href="inscription.html"><img class="compte" src="images/compte.svg" alt="compte" loading=lazy></a>
							<div class="sous-menu">
								<ul>
									<li>
										<?php
										...
										?>
											<a href='formcon_ins.html' style="float:right"> Connexion toto </a> <br>
										<?php 
										}
										?>
									...
									<li><a href="contact.html">Créer un compte</a></li>
								</ul>
							</div>
						</li>
						<li><a href="#"><img class="panier" src="images/panier.svg" alt="panier" loading=lazy></a></li> 
						<li><a href="#"><img class="eye" src="images/eye.svg" alt="eye" loading=lazy></a></li> 
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="slider">
			<img src="images/accueil/slider/slider1.png" alt="Slider" class="img_slider active" loading=lazy />
			<img src="images/accueil/slider/slider2.png" alt="Slider" class="img_slider" loading=lazy />
			<img src="images/accueil/slider/slider3.png" alt="Slider" class="img_slider" loading=lazy />	
		<div class="suivant">
	...
	<section class="meillsection">
		...
		<div class="row5">
			<div class="product-item">
					<div class="product_image">
						<img src="images/product_3.png" alt="" loading=lazy>
					</div>
					<div class="favorite"></div>
						<div class="product_info">
							<h5 class="product_name"><a href="#">Olives vertes</a></h5>
		...
		<div class="row5">
			<div class="product-item">
					<div class="product_image">
						<img src="images/produit3.png" alt="" loading=lazy>
					</div>
					<div class="favorite"></div>
						<div class="product_info">
							<h5 class="product_name"><a href="#">Huile d'olive vierge extra</a></h5>
		...
		<div class="row5">
			<div class="product-item">
					<div class="product_image">
						<img src="images/produit5.png" alt="" loading=lazy>
					</div>
					<div class="favorite"></div>
						<div class="product_info">
							<h5 class="product_name"><a href="#">Perles d'huile</a></h5>
		...
		<div class="row5">
			<div class="product-item">
					...
					<div class="favorite"></div>
						<div class="product_info">
							<h5 class="product_name"><a href="#">Huile d'olive bio</a></h5>
							<div class="product_price">9,99 €</div>
						</div>
					<div class="add_to_cart_button"><a href="#">ajouter au panier</a></div>
			</div>
	...
	<div class="small_container">
		...
		<div class="row">
			<div class="col-2">
				<img class="4raisons" src="images/4-1.png" alt="4raisons" loading=lazy>
					<p>Des produits de qualité</p>
			</div>
			<div class="col-2">
				<img class="4raisons" src="images/4-2.png" alt="4raisons" loading=lazy>
	...
	<div class="small_container">
		<div class="row">
			<div class="col-2">
				<img class="4raisons" src="images/4-3.png" alt="4raisons" loading=lazy>
					<p>Soutenir les petits producteurs</p>
			</div>
			<div class="col-2">
				<img class="4raisons" src="images/4-4.png" alt="4raisons" loading=lazy>
		...
		<div class="container">
			<div class="row">
				<div class="avantfooter-col">
					...
					<div class="avfooter">
						<img class="avfooterlogo" src="images/af1.png" alt="avfooterlogo" loading=lazy>
					</div>
				</div>
				<div class="avantfooter-col">
					<p>Aide et contact</p>
					<div class="avfooter">
						<img class="avfooterlogo" src="images/af2.png" alt="avfooterlogo" loading=lazy>
					</div>
				</div>
				<div class="avantfooter-col">
					<p>Retours gratuits</p>
					<div class="avfooter">
						<img class="avfooterlogo" src="images/af3.png" alt="avfooterlogo" loading=lazy>
					</div>
				</div>
				<div class="avantfooter-col">
					<p>Livraison gratuite dès 120€ d'achats</p>
					<div class="avfooter">
						<img class="avfooterlogo" src="images/af4.png" alt="avfooterlogo" loading=lazy>
					</div>
				</div>
			</div>
		</div>
